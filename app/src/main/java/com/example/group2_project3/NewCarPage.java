...
public class NewCarPage extends AppCompatActivity { // new working version :)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = findViewById(R.id.new_recycler);
        ...
        FirebaseRecyclerAdapter<Vehicles, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Vehicles, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Vehicles model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(NewCarPage.this, DetailActivity.class);
                    ...
                    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_car_templet, parent, false);

...
import com.example.group2_project3.Model.Products;
...
public class HomeActivity extends AppCompatActivity {
    ...
    @SuppressWarnings("statemnt with empty body")
//    @Override  NO NEED TO OVERRIDE HERE, JERRY
